...
/** \file
 *  \brief Board specific information header for the AVRISP mk II with Serial.
 *
 ...
 *  \brief Board specific information header for the AVRISP mk II with Serial.
 *
 *  Board specific information header for the AVRISP mk II with Serial.
 *
 *  @{
 */

#ifndef __BOARD_AVRISP_SERIAL_H__
#define __BOARD_AVRISP_SERIAL_H__
